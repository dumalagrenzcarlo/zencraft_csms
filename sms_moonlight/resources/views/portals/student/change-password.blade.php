...
<div class="mx-auto max-w-xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
    ...
    <form class="space-y-4" method="POST" action="{{ route('student.password.update') }}">
        @csrf
        <div>
            ...
            <div class="relative">
                ...
                <button class="password-visibility-toggle absolute inset-y-0 right-0 px-4 text-sm font-semibold text-sky-700 hover:text-sky-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sky-500" type="button" data-password-target="current_password" data-password-label="current password" aria-controls="current_password" aria-label="Show current password" aria-pressed="false">Show</button>
            </div>
        </div>
        <div>
            ...
            <div class="relative">
                ...
                <button class="password-visibility-toggle absolute inset-y-0 right-0 px-4 text-sm font-semibold text-sky-700 hover:text-sky-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sky-500" type="button" data-password-target="password" data-password-label="new password" aria-controls="password" aria-label="Show new password" aria-pressed="false">Show</button>
            </div>
        </div>
        <div>
            ...
            <div class="relative">
                ...
                <button class="password-visibility-toggle absolute inset-y-0 right-0 px-4 text-sm font-semibold text-sky-700 hover:text-sky-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sky-500" type="button" data-password-target="password_confirmation" data-password-label="password confirmation" aria-controls="password_confirmation" aria-label="Show password confirmation" aria-pressed="false">Show</button>
            </div>
        </div>
        <button class="w-full rounded-md bg-sky-600 px-4 py-2 font-semibold text-white hover:bg-sky-500" type="submit">Update Password</button>
    </form>
</div>
@endsection
