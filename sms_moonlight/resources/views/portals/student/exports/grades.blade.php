...
<body>
    ...
    <table class="grades">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="{{ count($termKeys) + 2 }}">No subjects or grades found.</td>
                </tr>
            @endforelse
    ...
    <div class="note">
        This PDF reflects the grade terms configured for {{ $class->grade->grade ?? 'this grade level' }}.
    </div>
</body>
</html>
